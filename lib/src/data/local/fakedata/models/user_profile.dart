class UserModel {
  ...
  bool? isLogged = false;
  List<UserActivityModel>? userActivities = <UserActivityModel>[];
  List<UserReviewsModel>? userReviews = <UserReviewsModel>[];
...
class UserReviewsModel {
  ...
  static List<UserReviewsModel> reviewsUserList = [
    UserReviewsModel(
        ...
        imageUrl: "assets/images/test/m1.jpeg",
        rating: "4.0"),
    UserReviewsModel(
        name: "Tyssedal",
        description: "Very Comfortable",
        imageUrl: "assets/images/test/m2.jpeg",
        rating: "4.4"),
    UserReviewsModel(
        name: "Net",
        description: "Very Cheap",
        imageUrl: "assets/images/test/m3.jpeg",
        rating: "2.4"),
    UserReviewsModel(
        name: "Net",
        description: "Very Cheap",
        imageUrl: "assets/images/test/m4.jpeg",
        rating: "3.5"),
    UserReviewsModel(
        name: "Net",
        description: "Very Cheap",
