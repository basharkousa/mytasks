...
class WidgetCarousel extends StatefulWidget {
  ...
  final Function(PageController carouselController)? onReturnCarouselController;

  const WidgetCarousel(
      {super.key, this.pages,
      ...
      this.currentIndex,
      this.onPageChange,
      this.onReturnCarouselController
      })
      : assert(pages != null),
  ...
  @override
  State createState() => WidgetCarouselState(currentIndex:currentIndex,onPageChange: onPageChange);
}
...
class WidgetCarouselState extends State<WidgetCarousel> {
  ...
  WidgetCarouselState({this.currentIndex,this.onPageChange});
  ...
  void initState() {
    super.initState();
     ...
     widget.onReturnCarouselController!(_controller);
    if (widget.autoplay!) {
...
//      _controller.initialPage = widget.currentIndex;
//    }
  }
